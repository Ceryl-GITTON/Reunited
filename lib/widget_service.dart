...
class WidgetService {
  ...
  static final DateTime _reunionDate =
      DateTime(2025, 9, 15, 10, 0); // 15 septembre 2025, 10h00
  ...
  static Future<void> updateWidget() async {
    ...
    try {
      ...
      if (difference.isNegative) {
        ...
        await HomeWidget.saveWidgetData<String>(
            'reunion_date', dateFormat.format(_reunionDate));
