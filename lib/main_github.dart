...
class _CountdownScreenState extends State<CountdownScreen>
  ...
  Map<String, Map<String, dynamic>> _getTimezones() => {
    'France': {
      'displayName': 'France',
  ...
  Future<void> _loadSavedData() async {
    try {
      ...
      // SharedPreferences non disponible (web), utiliser date par défaut
      _setDefaultReunionDate();
    }
  ...
  Future<void> _saveData() async {
    try {
      ...
      // SharedPreferences non disponible (web), ignorer
    }
  }
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Row(
            ...
            children: [
              Text('Où auront lieu les retrouvailles ? '),
              Text('🌍'),
            ],
          ),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: _getTimezones().entries.map((entry) {
            ...
            children: [
                                ...
                                Column(
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        _buildTimeCard(days, _getLocalizedTimeLabel(days, 'day')),
                                        _buildTimeCard(hours, _getLocalizedTimeLabel(hours, 'hour')),
                                        _buildTimeCard(minutes, _getLocalizedTimeLabel(minutes, 'minute')),
                                        _buildTimeCard(seconds, _getLocalizedTimeLabel(seconds, 'second')),
                                      ],
                                    ),
                                    ...
                                    if (_reunionDate != null)
                                      Column(
                                        children: [
                                          ...
                                          Builder(
                                            builder: (context) {
                                              final timezone = _getTimezones()[_selectedTimezone]!;
              ...
              Padding(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: const Text(
                    'Modifier la date de retrouvailles',
                    style: TextStyle(
                      color: Colors.white,
                      fontSize: 16,
                      fontWeight: FontWeight.bold,
