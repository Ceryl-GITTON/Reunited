...
class TimezoneConfig {
  ...
  static const List<String> availableTimezones = ['France', 'Indonesia', 'Local'];
  ...
  static String getTimezoneDisplayName(String timezoneKey, [String locale = 'en']) {
    switch (timezoneKey) {
      case 'France':
        switch (locale) {
          case 'fr': return 'France';
          case 'id': return 'Prancis';
          default: return 'France';
        }
      case 'Indonesia':
        switch (locale) {
          case 'fr': return 'Indonésie (Java)';
          case 'id': return 'Indonesia (Jawa)';
          default: return 'Indonesia (Java)';
        }
      case 'Local':
        switch (locale) {
          case 'fr': return 'Heure locale';
          case 'id': return 'Waktu lokal';
          default: return 'Local time';
        }
      default:
        return timezoneKey;
    }
