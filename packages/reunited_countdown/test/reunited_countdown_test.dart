...
void main() {
  group('ReunitedCountdown Package Tests', () {
    testWidgets('ReunitedCountdown widget renders correctly',
    ...
    test('CountdownConfig copyWith works correctly', () {
      ...
      expect(newConfig.locale.languageCode,
          equals('en')); // Should remain unchanged
    });
    ...
    test('TimezoneConfig display names are correct', () {
      ...
      expect(TimezoneConfig.getTimezoneDisplayName('France', 'en'),
          equals('France'));
      expect(TimezoneConfig.getTimezoneDisplayName('France', 'fr'),
          equals('France'));
      expect(TimezoneConfig.getTimezoneDisplayName('France', 'id'),
          equals('Prancis'));

      expect(TimezoneConfig.getTimezoneDisplayName('Indonesia', 'en'),
          equals('Indonesia (Java)'));
      expect(TimezoneConfig.getTimezoneDisplayName('Indonesia', 'fr'),
          equals('Indonésie (Java)'));
      expect(TimezoneConfig.getTimezoneDisplayName('Indonesia', 'id'),
          equals('Indonesia (Jawa)'));
    });

    testWidgets('ReunitedCountdown with custom theme renders correctly',
        (WidgetTester tester) async {
    ...
    testWidgets('ReunitedCountdown with disabled features works',
        (WidgetTester tester) async {
